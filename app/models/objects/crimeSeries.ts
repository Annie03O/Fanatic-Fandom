    ...
    movies: [
      	{
            base: {
                ...
                plot: ["Police officer Johan Falk has been given a new position at GSI, the Special Operations Group, in Gothenburg. After five years with Organized Crime at Europol, he returns to Sweden and is reunited with his old colleagues and friends, Patrik Agrell and Tommy Ridders.",
                    "Johan learns that a series of cash-in-transit robberies have taken place in Gothenburg over the past year. He is involved in the arrest of heroin importer Eric Davoda, who is suspected of having something to do with the robberies. However, GSI is unable to determine the identities of the cash-in-transit robbers, who are internally known as “The Unknown Six.”",
                    "Later, GSI checks into the Gothia Towers Hotel after receiving a tip that one or more of the robbers are staying there. When Johan’s colleague Tommy Ridders is shot and killed at the Gothia Towers, Johan discovers that the reason behind the unit’s success is that they have informants embedded within the criminal underworld.",
                    "In connection with this, Johan also comes into contact with a person known as Lisa, who claims to have known Tommy. Lisa has turned to Johan for help in protecting herself and her family.",],
